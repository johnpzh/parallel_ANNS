//
// Created by Zhen Peng on 03/14/2021.
//
...
#include "../include/efanna2e/index_nsg.202103121531.neighbor_distance_step.h"
...
//        const efanna2e::Parameters &paras,
        ...
        double &avg_iters)
{
    index.set_kNN_step_dist_.resize(K, std::make_pair(0.0, 0.0));
    /* ----------------------
     * ------- Kernel ------- */
...
//            continue;
//        }
        index.Search_cand_point_step_dist(
                i,
                query_load + i * dim,
                data_load,
                K,
...
//    {// Average distance to the query
//        for (idi s_i = 0; s_i < index.count_every_step_for_candidates_.size(); ++s_i) {
//            if (0 == index.count_every_step_for_candidates_[s_i]) {
//                continue;
//            }
//            printf("%u\t"
//                   "%f\t"
//                   "%f\n",
//                   s_i,
//                   index.profile_step_to_avg_dist_to_query_[s_i] / index.count_every_step_for_candidates_[s_i],
//                   index.profile_step_to_dist_to_parent_[s_i] / index.count_every_step_for_neighbors_[s_i]);
////            printf("%u\t%f\n", s_i, index.profile_step_to_avg_dist_to_query_[s_i] / index.count_every_step_[s_i]);
//        }
//        index.profile_step_to_avg_dist_to_query_.clear();
//        index.profile_step_to_dist_to_parent_.clear();
//        index.count_every_step_for_candidates_.clear();
//        index.count_every_step_for_neighbors_.clear();
//    }
//    {// kNN step and distance
//        for (idi e_i = 0; e_i < K; ++e_i) {
//            printf("%f\t"
//                   "%f\n",
//                   index.set_kNN_step_dist_[e_i].first / query_num,
//                   index.set_kNN_step_dist_[e_i].second / query_num);
//        }
//    }
    runtime = diff.count();
