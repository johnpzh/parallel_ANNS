//
// Created by Zhen Peng on 06/14/2020.
//
...
#include "../core/Searching.202106170130.PSS_LG_bfs_parallel_path_subgraph.h"
//#define DEBUG_PRINT
...
//                engine.prepare_init_ids(init_ids, L_local);
                ...
                for (unsigned q_i = 0; q_i < query_num; ++q_i) {
                    ...
                    engine.PSS_parallel_expanded_vertices(
                            q_i,
                            K,
                            L_master,
                            set_L,
...
//            my_step);
    ...
    idi cnt_filtered_out = filter_out_non_subgraph_vertices(
            num_threads,
            points_num,
            is_connected_to_nn,
            is_search_expanded);
