//
// Created by Zhen Peng on 05/17/2020.
//
...
//                engine.prepare_init_ids(init_ids, L_local);
                ...
                for (unsigned q_i = 0; q_i < query_num; ++q_i) {
                    ...
                    printf("query_id: %u\n", q_i);
#endif
                    double latency = -PANNS::WallTimer::get_time_mark();
                    ...
                    latency += PANNS::WallTimer::get_time_mark();
                    latency_of_queries[q_i] = latency * 1000.0;
                }
