...
#include "../core/Searching.202111110022.PSS_v5.index_adaptive_merge.LG.h"
...
//            "Usage: %s <data_file> <query_file> <nsg_path> <L_lower> <K> <result_file> <true_NN_file> <num_threads> <sub_iters> <L_upper> <P@100> [<P@100> ...]\n",
                ...
                "<L_lower> <L_upper> <index_threshold> <P@100> [<P@100> ...]\n",
                argv[0]);
        exit(EXIT_FAILURE);
    }
}
...
//    const unsigned index_threshold = strtoull(argv[10], nullptr, 0);
    const double index_ratio = strtod(argv[10], nullptr);
