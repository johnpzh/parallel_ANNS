...
#include "../core/Searching.202103191537.PSS_v5.sequence_traverse.h"
...
//    omp_set_max_active_levels(2);
    ...
    const uint64_t compt_thrd = strtoull(argv[20], nullptr, 0);
...
//                engine.prepare_init_ids(init_ids, L_local);
                ...
                for (unsigned q_i = 0; q_i < query_num; ++q_i) {
                    engine.para_search_PSS_v5_dist_thresh_profiling_in_sequence(
                            q_i,
                            K,
                            L_master,
                            set_L,
