...
#include "../core/Searching.202111171644.PSS_v5.worker_std_deviation.LG.h"
//#define DEBUG_PRINT
void usage(int argc, char *argv[])
{
    if (argc != 15) {
        fprintf(stderr,
                ...
                "<L_local_up> <L_local_step> <std_dev_threshold>\n",
                argv[0]);
//        fprintf(stderr,
//                "Usage: %s <data_file> <query_file> <nsg_path> "
//                "<K> <result_file> <true_NN_file> <num_threads> "
...
//    omp_set_max_active_levels(2);
    ...
    const float std_dev_threshold = strtod(argv[14], nullptr);
...
//                {// print local_merge
//                    printf("query_id:\tlocal_merge:\n");
//                }
//                std::vector<unsigned> queries_chosen = {0,2,3,4,7,9,10,11,15,16};
...
//                    std::vector<PANNS::idi> every_step_median;
//                    std::vector<PANNS::idi> merge_step;

                    engine.para_search_PSS_v5_worker_std_deviation_LG(
                            q_i,
                            K,
                            L_master,
                            set_L,
...
//                            printf("%u\t%f\t%u",
//                                   s_i+1,
//                                   every_step_variance[s_i],
//                                   every_step_median[s_i]);
//                            if (std::find(merge_step.begin(), merge_step.end(), s_i + 1) != merge_step.end()) {
//                                // found
//                                printf("M");
//                            }
//                            printf("\n");
