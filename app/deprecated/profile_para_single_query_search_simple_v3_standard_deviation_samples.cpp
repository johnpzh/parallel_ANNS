...
#include <clocale>
#include <omp.h>
#include "../core/Searching.202011011451.simple_v3.std_dev.h"
...
//                std::vector<uint8_t> is_visited(points_num, 0);
                ...
                engine.stddev_every_x_.resize(subsearch_iterations, 0.0);
                ...
                for (unsigned q_i = 0; q_i < query_num; ++q_i) {
                    ...
                    engine.para_search_with_simple_v3_stddev_samples(
                            q_i,
                            K,
                            L,
                            set_L,
...
//                        accum_stddev += engine.stddev_every_x_[inner_iter];
//                        printf("%u\t%f\t%f\n",
//                               inner_iter, engine.stddev_every_x_[inner_iter], accum_stddev);
//                    }
//                }
                {// Basic output
                    printf(
