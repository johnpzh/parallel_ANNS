...
{
    fprintf(stderr,
            "Usage: %s <data_file> <query_file> <nsg_path> <L> <K> <result_file> <true_NN_file> <L_termn>\n",
            argv[0]);
}
...
//    }
    ...
    unsigned L_termn = strtoull(argv[8], nullptr, 0);
...
//        }
//        std::vector<PANNS::idi> top_m_candidates(1);
...
//            engine.seq_search_with_top_m_middle(
            engine.seq_search_simple_search_early_termination(
