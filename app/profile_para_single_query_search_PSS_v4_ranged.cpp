...
#include "../core/Searching.202012141643.simple_v3.scale_M.h"
...
//                std::vector<PANNS::idi> top_m_candidates(num_threads);
                ...
                for (unsigned q_i = 0; q_i < query_num; ++q_i) {
                    engine.para_search_with_simple_v3_with_sequential_start(
                            q_i,
                            K,
                            L,
                            set_L,
...
//                            top_m_candidates);
//                    engine.para_search_with_simple_v3_with_scale_M(
//                            q_i,
//                            K,
//                            L,
//                            set_L,
