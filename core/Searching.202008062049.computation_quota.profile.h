...
//        const idi group_size)
{
    ...
    idi top_m_count = 0;
//    std::vector<idi> tmp_sizes(num_groups, 0);
//    idi tmp_sizes[2] = {0, 0};
...
//        top_m_candidates[top_m_candidates_starts[g_i] + tmp_sizes[g_i]++] = set_L[c_i].id_;
//        top_m_candidates[top_m_candidates_sizes[g_i]] = set_L[c_i].id_;
//        top_m_candidates[top_m_candidates_sizes[g_i]++] = set_L[c_i].id_;
//        top_m_candidates[top_m_candidates_starts[g_i] + top_m_candidates_sizes[g_i]] = set_L[c_i].id_;
//        ++top_m_candidates_sizes[g_i];
        top_m_candidates[top_m_candidates_starts[g_i] + top_m_candidates_sizes[g_i]++] = set_L[c_i].id_;

    }
//    top_m_candidates_sizes[0] = tmp_sizes[0];
//    top_m_candidates_sizes[1] = tmp_sizes[1];
//    std::fill(top_m_candidates_sizes.begin(), top_m_candidates_sizes.end(), M / num_groups);
//    top_m_candidates_sizes[0] = M / num_groups;
//    top_m_candidates_sizes[1] = M / num_groups;
//    std::copy(tmp_sizes.begin(), tmp_sizes.end(), top_m_candidates_sizes.begin());
//    top_m_candidates_sizes[0] = tmp_sizes[0]; top_m_candidates_sizes[1] = tmp_sizes[1];
    return top_m_count;
