...
#include "Searching.202010301220.simple_v3.large_graph.num_checked.h"
 ...
 */
void Searching::para_search_with_simple_v3_large_graph_num_checked(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
void Searching::para_search_with_simple_v3_large_graph_num_checked_every_x(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
        ...
        const std::vector<idi> &local_queues_sizes)
{
    ...
    count_x_checked_[inner_step] += num_checked;
    ++count_x_merge_[inner_step];
}
