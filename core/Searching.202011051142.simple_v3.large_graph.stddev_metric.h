...
//    void build_opt_graph();
    ...
    void para_search_with_simple_v3_large_graph(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void para_search_with_simple_v3_large_graph_stddev_metric(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void para_search_with_simple_v3_large_graph_stddev_metric_samples(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void print_stddev_metric_top_ones_checked(
    ...
    void print_stddev_metric_top_ones_unchecked(
            const idi total_iter,
            const std::vector<Candidate> &set_L,
            const std::vector<idi> &local_queues_starts,
            const std::vector<idi> &local_queues_sizes,
