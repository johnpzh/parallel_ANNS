...
//    uint64_t count_iterations_ = 0;
    ...
    std::vector<idi> points_every_rank_;
    std::vector<idi> counts_every_rank_;
...
//    void build_opt_graph();
    ...
    void para_search_with_simple_v3_large_graph_worst_and_best(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void compare_worst_and_best_unchecked(
