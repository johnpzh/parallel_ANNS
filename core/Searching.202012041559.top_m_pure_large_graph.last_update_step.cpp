//
// Created by Zhen Peng on 12/04/2020.
//

#include "Searching.202012041559.top_m_pure_large_graph.last_update_step.h"
...
//        double test_time_iter = -WallTimer::get_time_mark();
        ...
        {// last update step
            for (idi e_i = 0; e_i < L; ++e_i) {
                bak_global_queue[e_i] = set_L[master_queue_start + e_i].id_;
            }
        }
...
//            threads_computations_[0] += tmp_count_computation;
        ...
        {// last update step
            for (idi e_i = 0; e_i < L; ++e_i) {
                if (bak_global_queue[e_i] != set_L[master_queue_start + e_i].id_) {
