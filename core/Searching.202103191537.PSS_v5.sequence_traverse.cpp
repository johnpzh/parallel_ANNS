//
// Created by Zhen Peng on 03/19/2021.
//

#include "Searching.202103191537.PSS_v5.sequence_traverse.h"
...
//        idi nb_id = (cand_id + e_i) % num_v_;
//        _mm_prefetch(opt_nsg_graph_ + nb_id * vertex_bytes_, _MM_HINT_T0);
//    }
...
void Searching::para_search_PSS_v5_dist_thresh_profiling_in_sequence(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
        ...
        boost::dynamic_bitset<> &is_visited,
        const idi subsearch_iterations,
        const uint64_t compt_thrd) // for perf
{
