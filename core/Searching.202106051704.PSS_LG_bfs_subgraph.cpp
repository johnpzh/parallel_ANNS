//
// Created by Zhen Peng on 06/05/2020.
//

#include "Searching.202106051704.PSS_LG_bfs_subgraph.h"
...
void Searching::do_bfs_to_all_monotonic_in_some_steps(
        const idi query_id,
        const idi step_bound,
        std::vector<bool> &is_reached,
        std::vector<idi> &my_step,
        std::vector<distf> &my_distance,
        std::vector< std::vector<idi> > &edgelist) const
...
void Searching::PSS_parallel_expanded_vertices(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
//    idi top_m_candidates_end = 0;
    ...
    is_search_expanded[num_threads_ - 1][ep_] = true;
//    my_parent[ep_] = ep_;
