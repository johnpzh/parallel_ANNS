//
// Created by Zhen Peng on 07/29/2020.
//

#include "Searching.202107292234.PSS_v5.multi_queries.LG.h"
...
void Searching::para_search_PSS_v5_multi_queries_LG(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
//        std::vector<idi> &top_m_candidates)
{
    ...
    const int num_workers = num_threads_inner_;
