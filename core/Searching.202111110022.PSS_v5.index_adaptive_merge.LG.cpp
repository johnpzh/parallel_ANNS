//
// Created by Zhen Peng on 11/11/2021.
//

#include "Searching.202111110022.PSS_v5.index_adaptive_merge.LG.h"
...
void Searching::para_search_PSS_v5_index_adaptive_merge_LG(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
//                            local_best_firsts[w_i] = set_L[local_queue_start + r].distance_;
                        ...
                        {// Check the metrics
//                            if (not_merged_yet && w_i == checker_id) {
                            if (w_i == checker_id) {
                                if (get_index_mean(local_best_index) >= index_threshold) {
                                    need_merge = true;
                                }
...
//                not_merged_yet = false; // indicates that the merge has happened.
                need_merge = false;
//                {// record the step
