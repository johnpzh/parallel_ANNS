...
//        // Norm and data
//        distf norm = compute_norm(v_id);
//        std::memcpy(location, &norm, sizeof(distf)); // Norm
//        memcpy(location + sizeof(distf), data_load_ + v_id * dimension_, dimension_ * sizeof(dataf)); // Data
//        location += data_bytes_;
//
//        // Neighbors
//        memcpy(location, &degree, sizeof(idi)); // Number of neighbors
////        fin.read(location + sizeof(idi), degree * sizeof(unsigned)); // Neighbors
//        memcpy(location + sizeof(idi), tmp_ngbrs.data(), degree * sizeof(unsigned));
//        location += neighbor_bytes_;
//        ++v_id;
//    }
//    if (v_id != num_v_) {
