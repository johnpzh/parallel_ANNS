//
// Created by Zhen Peng on 11/01/2020.
//

#include "Searching.202011011451.simple_v3.std_dev.h"
 ...
 * 11/01/2020-14:17
 */
void Searching::para_search_with_simple_v3_stddev(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
void Searching::stddev_top_ones(
 ...
 * 11/01/2020-15:47
 */
void Searching::para_search_with_simple_v3_stddev_samples(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
void Searching::print_stddev_top_ones(
        const idi total_iter,
        const std::vector<Candidate> &set_L,
        const std::vector<idi> &local_queues_starts,
        const std::vector<idi> &local_queues_sizes,
        double &stddev_accum) // Sizes of local queue
{
    // global mean of all top-first
    double global_mean;
    std::vector<double> tops(num_threads_, 0.0);
...
void Searching::para_search_with_simple_v3_stddev_metric(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
 ...
 * 11/01/2020-15:47
 */
void Searching::para_search_with_simple_v3_stddev_metric_samples(
//        const idi M,
//        const idi worker_M,
        const idi query_id,
        const idi K,
...
void Searching::print_stddev_metric_top_ones(
        const idi total_iter,
        const std::vector<Candidate> &set_L,
        const std::vector<idi> &local_queues_starts,
        const std::vector<idi> &local_queues_sizes,
