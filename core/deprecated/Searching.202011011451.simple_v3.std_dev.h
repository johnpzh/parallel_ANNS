...
//    uint64_t count_checked_ = 0;
    ...
    std::vector<double> stddev_every_x_;
    std::vector<double> stddev_metric_every_x_;
...
//    void build_opt_graph();
    ...
    void para_search_with_simple_v3_stddev(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
...
//        const idi worker_M,
    ...
    void para_search_with_simple_v3_stddev_metric(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void stddev_metric_top_ones(
            const idi inner_iter,
            const std::vector<Candidate> &set_L,
            const std::vector<idi> &local_queues_starts,
            const std::vector<idi> &local_queues_sizes);

    void para_search_with_simple_v3_stddev_metric_samples(
//        const idi M,
//        const idi worker_M,
            const idi query_id,
            const idi K,
    ...
    void print_stddev_metric_top_ones(
            const idi total_iter,
            const std::vector<Candidate> &set_L,
            const std::vector<idi> &local_queues_starts,
            const std::vector<idi> &local_queues_sizes,
            double &stddev_metric_accum);
