...
set -x
bin=./profile_para_single_query_search_simple_v3_stddev_metric_samples
#bin=./profile_para_single_query_search_simple_v3_standard_deviation_samples
...
###### P@100 0.90
P_target=0.900
output="output.PSS_stddev_samples_${data_name}_T${num_t}_${P_target}.txt"
L_low=92
L_up=92
L_step=1
X_low=10
