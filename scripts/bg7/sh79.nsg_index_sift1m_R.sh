...
data_dir="/scratch/zpeng/data/sift1m"
data=sift
...
#done
for R in 64 32 16 8 4; do
    ./test_nsg_index ${data_dir}/${data}_base.fvecs ${data_dir}/${data}_200nn.graph 40 ${R} 500 ${data_dir}/${data}_R${R}.nsg
done
