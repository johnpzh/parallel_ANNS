...
data="sift"
app_tag="parallel_search_path_subgraph_w_nonmono"
...
./PSS_LG_parallel_search_path_in_subgraph_w_nonmono ${data_dir}/${data}_base.fvecs ${data_dir}/${data}_query.fvecs ${data_dir}/${data}.nsg 100 ${output_tag}.txt ${data_dir}/${data}.true-100_NN.v2.binary ${num_t} ${L} ${L} 1 0 0 0 ${X} ${X} 1 0 0 0 ${q_id}
python ../tools/plot_parallel_search_path_in_subgraph_w_nonmono.py ${output_tag}.txt ${output_tag}.png ${data} ${q_id}
