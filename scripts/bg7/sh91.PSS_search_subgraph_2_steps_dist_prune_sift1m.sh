...
data="sift"
app_tag="parallel_search_path_2_steps_dist_prune"
...
./PSS_LG_parallel_search_path_2_steps_dist_prune ${data_dir}/${data}_base.fvecs ${data_dir}/${data}_query.fvecs ${data_dir}/${data}.nsg 100 ${output_tag}.txt ${data_dir}/${data}.true-100_NN.v2.binary ${num_t} ${L} ${L} 1 0 0 0 ${X} ${X} 1 0 0 0 ${q_id}
