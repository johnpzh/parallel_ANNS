...
bin=./profile_para_single_query_top_m_search_selecting_out
#value_m=128
#value_M_middle=4
...
for (( l = l_start; l < l_bound; l += l_step )); do
    ${bin} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs $((value_m/num_t)) ${data_path}/${data_name}.true-100_NN.q-10000.binary ${num_t} $l
...
l_step=30
for (( l = l_start; l < l_bound; l += l_step )); do
    ${bin} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs $((value_m/num_t)) ${data_path}/${data_name}.true-100_NN.q-1000.binary ${num_t} $l
