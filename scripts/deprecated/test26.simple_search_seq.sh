...
#done
${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 100 | tee -a output.${tag}.raw.txt
