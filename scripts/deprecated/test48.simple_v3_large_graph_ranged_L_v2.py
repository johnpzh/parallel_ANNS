...
if len(sys.argv) != 11:
    print(f"{sys.argv[0]} <data_dir> <tag> <num_t> <L_low> <L_up> <L_step> <X_low> <X_step> <Q_num> <#init>")
...
#           F"{num_t} {L_max} {L_step} {X_low} {X_step} {Q_num} {init_count}" \
#           F"| tee -a {raw_file}"
