...
app="profile_find_L_para_single_query_scale_m_search_pure_large_graph_profiling"
app_label="Scale_M"
#M=128
...
###
    ...
    L_low=$(( L_Seq - offset ))
    L_up=$(( L_Seq ))
    tag="${app_label}_M${M}_T${num_t}_P${P_target}"
    ...
    ######
    output_files="output.${data}.${app_label}_M${M}_T${num_t}_P0.9"
    table_file="output.${data}.${app_label}_M${M}_T${num_t}_collected.table.txt"
