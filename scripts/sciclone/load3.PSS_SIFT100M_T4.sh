...
#PBS -N sift100M_PSS_T4
#PBS -j oe
#PBS -m abe
#PBS -o output.sift100M_PSS_T4.txt
...
${bin} /sciclone/pscr/zpeng01 PSS_T${num_t}_L100-200 ${num_t} 100 200 8 2 16
${bin} /sciclone/pscr/zpeng01 PSS_T${num_t}_L200-400 ${num_t} 200 400 16 2 32
