...
#./PSS_v5_LG_degree_reorder /scratch/zpeng/sift1m/sift_base.fvecs /scratch/zpeng/sift1m/sift_query.fvecs /scratch/zpeng/sift1m/sift.nsg 100 output.ivecs /scratch/zpeng/sift1m/sift.true-100_NN.v2.binary 1 413 413 1 0 0 0 999999 999999 1 /scratch/zpeng/sift1m/sift_reorder_map.expand.binary 1000000
#python3 ../scripts/test67.PSS_v5_count_reorder_ranged_L.py PSS_v5_LG_degree_reorder /scratch/zpeng sift1m test 1 413 413 8 0 0 0 99999 99999 8 1000000 expand
