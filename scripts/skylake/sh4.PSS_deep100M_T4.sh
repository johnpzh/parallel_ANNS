...
set -x
$(bin) ${data_path} SV3_T4_L90-100 4 90 100 2 1 2
$(bin) ${data_path} SV3_T4_L100-400 4 100 400 32 2 64
$(bin) ${data_path} SV3_T4_L400-800 4 400 800 64 2 128
$(bin) ${data_path} SV3_T4_L800-1600 4 800 1600 128 2 256
#${bin} ${data_path} SV3_T4_L1600-3200 4 1600 3200 64 2 128
#${bin} ${data_path} SV3_T4_L3200-5000 4 3200 5000 128 2 256

#${bin} ${data_path} SV3_T2_L90-100 2 90 100 2 1 2
#${bin} ${data_path} SV3_T2_L100-400 2 100 400 16 2 16
#${bin} ${data_path} SV3_T2_L400-800 2 400 800 32 2 64
#${bin} ${data_path} SV3_T2_L800-1600 2 800 1600 128 2 256
#${bin} ${data_path} SV3_T2_L1600-3200 2 1600 3200 256 2 512
##${bin} ${data_path} SV3_T4_L3200-5000 4 3200 5000 128 2 256
