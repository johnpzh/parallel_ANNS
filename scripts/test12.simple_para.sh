...
#bin_panns=./profile_para_multi_queries_top_m_search_vtune
#bin_panns="numactl -m 0 ./profile_para_multi_queries_top_m_search_vtune"
bin_panns="numactl -m 0 ./app_para_searching"
#num_t_max=16
#num_t_max=20
num_t_max=40
#num_t_max=2
