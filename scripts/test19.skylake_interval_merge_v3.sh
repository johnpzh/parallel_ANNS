...
bin="numactl -m 0 ./profile_para_single_query_top_m_search_interval_merge.v3"
#bin="numactl -m 0 ./profile_para_single_query_top_m_search_middle_m"
...
#        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 128 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 4 70 ${sub_iter} ${compt} | tee -a output.${tag}.raw.txt
##        numactl -m 0 ./profile_para_single_query_top_m_search_interval_merge.v3 ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 128 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 8 70 ${sub_iter} ${compt} > output.${sub_iter}.txt
#    done
#done
:> output.${tag}.raw.txt
#for compt in 90000000 ; do
for compt in  70000000 73000000 76000000 80000000 83000000 86000000 90000000; do
