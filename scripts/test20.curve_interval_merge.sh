...
for compt in 50000000 60000000 70000000 80000000 90000000; do
    ...
    for (( l = l_start; l < l_bound; l += l_step )); do
        ${bin} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs ${value_m} ${data_path}/${data_name}.true-100_NN.q-10000.binary ${num_t} ${num_t} $((l/2)) ${sub_iter} ${compt} | tee -a output.${label}.raw.txt
    done
