...
bin="./profile_para_single_query_top_m_search_simple_top_m"
...
for M in 8 16 32 64 128; do
    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs ${M} ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 200 ${sub_iter} 200000000 | tee -a output.${tag}.raw.txt
