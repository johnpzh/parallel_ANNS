...
#### M128
label="${tag}.T2.M128.Intv1-12"
:> output.${label}.raw.txt
for width in 1 2 4 8 16 32 64; do
    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 128 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 2 200 ${sub_iter} 200000000 ${width} | tee -a output.${label}.raw.txt
    done
done
...
##### M128
#label="${tag}.M128.Intv1-12"
#:> output.${label}.raw.txt
#for width in 1 2 4 8 16; do
#    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
#        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 128 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 200 ${sub_iter} 200000000 ${width} | tee -a output.${label}.raw.txt
#    done
#done
#
#python3 ../scripts/output_format.py output.${label}.raw.txt output.${label}.row.txt 3 4 11 13 14 16 17;
...
#
######## M64 #######
#label="${tag}.M64.Intv1-12"
#:> output.${label}.raw.txt
#for width in 1 2 4 8; do
#    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
#        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 64 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 200 ${sub_iter} 200000000 ${width} | tee -a output.${label}.raw.txt
#    done
#done
#
#python3 ../scripts/output_format.py output.${label}.raw.txt output.${label}.row.txt 3 4 11 13 14 16 17;
...
#
######## M32 #######
#label="${tag}.M32.Intv1-12"
#:> output.${label}.raw.txt
#for width in 1 2 4; do
#    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
#        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 32 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 200 ${sub_iter} 200000000 ${width} | tee -a output.${label}.raw.txt
#    done
#done
#
#python3 ../scripts/output_format.py output.${label}.raw.txt output.${label}.row.txt 3 4 11 13 14 16 17;
...
#
######## M16 #######
#label="${tag}.M16.Intv1-12"
#:> output.${label}.raw.txt
#for width in 1 2; do
#    for ((sub_iter = 1; sub_iter <= 12; ++sub_iter)); do
#        ${bin} ${data_dir}/sift1m/sift_base.fvecs ${data_dir}/sift1m/sift_query.fvecs ${data_dir}/sift1m/sift.nsg 200 200 output.ivecs 16 ${data_dir}/sift1m/sift.true-100_NN.q-10000.binary 8 200 ${sub_iter} 200000000 ${width} | tee -a output.${label}.raw.txt
#    done
#done
#
#python3 ../scripts/output_format.py output.${label}.raw.txt output.${label}.row.txt 3 4 11 13 14 16 17;
