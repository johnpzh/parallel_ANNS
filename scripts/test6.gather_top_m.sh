...
#echo "-- Selecting --"
#python3 ../scripts/module_run.py ./profile_para_single_query_top_m_search_selecting_out.profile.gather_top_m.seq_par.mth gist ~/data 256 ~/data/gist1m/gist.true-100_NN.q-1000.binary 4 400 4
#
#echo "-- Middle --"
...
#    echo "----${data_name}----"
#echo "--Selecting--"
#bin_panns=./profile_para_single_query_top_m_search_selecting_out.profile.gather_top_m.seq_par.mth
#    ${bin_panns} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs ${value_m} ${data_path}/${data_name}.true-100_NN.q-10000.binary 8 200 4
#
#echo "--Middle--"
...
echo "--Selecting--"
bin_panns=./profile_para_single_query_top_m_search_selecting_out.profile.gather_top_m.seq_par.mth
    ${bin_panns} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs ${value_m} ${data_path}/${data_name}.true-100_NN.q-1000.binary 8 200 4

echo "--Middle--"
bin_panns=./profile_para_single_query_top_m_search_middle_m.profile
    ${bin_panns} ${data_path}/${data_name}_base.fvecs ${data_path}/${data_name}_query.fvecs ${data_path}/${data_name}.nsg $l $k output.ivecs ${value_m} ${data_path}/${data_name}.true-100_NN.q-1000.binary 8 4
